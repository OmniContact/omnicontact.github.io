...
/**
 * Convert Euler angles (XYZ extrinsic / ZYX intrinsic) to quaternion [w,x,y,z].
 * @param {number} rx - rotation about X axis (radians)
 * @param {number} ry - rotation about Y axis (radians)
 * @param {number} rz - rotation about Z axis (radians)
